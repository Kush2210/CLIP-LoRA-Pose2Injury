...
def get_arguments():
    ...
    parser.add_argument('--root_path', type=str, default='/home/sahil/CLIP-LoRA/DATASET/test')
    ...
    parser.add_argument('--eval_only', default=True, action='store_true', help='only evaluate the LoRA modules (save_path should not be None)')
