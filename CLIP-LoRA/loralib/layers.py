...
class PlainMultiheadAttentionLoRA(nn.Module):
    def __init__(
        ...
        self.scaled_dot_product_attention = getattr(F, "scaled_dot_product_attention", None)
    ...
    def forward_module(
        ...
        if hasattr(F, "_canonical_mask") and hasattr(F, "_none_or_dtype"):
        ...
        if self.scaled_dot_product_attention is not None:
